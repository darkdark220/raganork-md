...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || ''Raganork~74f4d52c157dcb3d3be0888533359f1b:5a702b725945576a6b61343d'',
    ...
    ALLOWED: process.env.ALLOWED || '91,94,2,249',
    ...
    SUDO: process.env.SUDO || "249962216561",
